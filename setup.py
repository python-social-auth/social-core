...
requirements = requirements_base + read_requirements('requirements-python%s.txt' % PY)
...
tests_requirements = tests_requirements_base + read_tests_requirements('requirements-python%s.txt' % PY)
