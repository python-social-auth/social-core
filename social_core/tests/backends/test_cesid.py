...
class CesidOpenIdConnectTest(OpenIdConnectTest, BaseAuthUrlTestMixin):
    ...
    expected_username = "cesiduser"
    user_data_url = "https://login.cesid.cesnet.cz/cas/oidc/oidcProfile"
    user_data_body = json.dumps(
        {
            "preferred_username": "cesiduser",
    ...
    def test_get_user_details_custom_username_key(self) -> None:
        ...
        details = self.backend.get_user_details(response)
        self.assertEqual(details["username"], "cesiduser")
